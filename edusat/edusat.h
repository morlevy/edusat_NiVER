...
typedef unordered_set<Lit> clause_set_t;
typedef clause_set_t::iterator clause_set_it;
...
class Solver {
    ...
    vector<Clause> beforeNiverClauses; // clauses that we need to check later.
    vector<Clause> niverUncheckedClauses; // clauses that we need to check later.
	vector<int> unaries;
